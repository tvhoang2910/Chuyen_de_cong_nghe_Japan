...
const GOOGLE_AUTH_URL = `${import.meta.env.VITE_AUTH_BASE_URL || "http://localhost:8081/api/v1/auth"}/oauth2/authorization/google`;
...
const registerSchema = z
  .object({
    ...
    confirmPassword: z
      .string()
      .min(8, "Xác nhận mật khẩu phải từ 8 ký tự trở lên"),
  })
  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      ...
      if (res.status === 201) {
        ...
        navigate(
          `/register/verify-email?email=${encodeURIComponent(data.email.trim().toLowerCase())}`,
        );
      }
    } catch {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{ x: [0, 12, -16, 0], y: [0, -16, 10, 0] }}
          ...
          <div className="auth-perspective w-full max-w-2xl">
            ...
            >
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-slate-200">
                Tạo tài khoản trong vài giây để dùng kho đề thi lớn, hệ thống ôn
                tập cá nhân hóa và lộ trình ghi nhớ dài hạn.
              </p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                {[
                  ...
                  >
                    ...
                    <p className="mt-3 text-[11px] font-black uppercase tracking-[0.14em] text-slate-300">
                      {item.title}
                    </p>
        ...
        <div className="flex w-full items-center justify-center p-6 sm:p-10 lg:w-1/2 lg:p-14">
          ...
          >
            <div className="mb-8 flex items-center justify-between">
              <Link
                to="/"
                className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-[11px] font-black uppercase tracking-[0.14em] text-slate-600 hover:border-emerald-200 hover:text-emerald-700"
              >
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm font-medium text-slate-500">
                Thiết lập hồ sơ học tập của bạn và bắt đầu ngay.
              </p>
            </div>
            ...
            >
              ...
              >
                <path
                  fill="#EA4335"
                  d="M12 10.2v3.9h5.5c-.2 1.2-.9 2.3-1.9 3.1l3 2.3c1.8-1.6 2.8-4 2.8-6.8 0-.6-.1-1.2-.2-1.8H12z"
                />
                <path
                  fill="#34A853"
                  d="M12 21c2.6 0 4.8-.9 6.4-2.5l-3-2.3c-.8.6-1.9 1-3.4 1-2.6 0-4.9-1.8-5.7-4.3l-3.1 2.4C4.7 18.8 8.1 21 12 21z"
                />
                <path
                  fill="#FBBC05"
                  d="M6.3 12.9c0-.7.1-1.3.3-1.9L3.5 8.6C2.9 9.9 2.5 11.4 2.5 12.9c0 1.5.4 3 1 4.3l3.1-2.4c-.2-.6-.3-1.2-.3-1.9z"
                />
                <path
                  fill="#4285F4"
                  d="M12 8.6c1.4 0 2.7.5 3.7 1.4l2.8-2.8C16.8 5.7 14.6 4.8 12 4.8c-3.9 0-7.3 2.2-8.9 5.4L6.2 12c.8-2.5 3.1-3.4 5.8-3.4z"
                />
              </svg>
              Tiếp tục với Google
            </motion.button>
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              <div className="space-y-2">
                <label
                  ...
                  className="ml-1 text-xs font-black uppercase tracking-[0.14em] text-slate-500"
                >
                  Họ và tên
                </label>
                ...
                {errors.fullName && (
                  <p className="ml-1 mt-1 text-xs font-bold text-rose-500">
            ...
            <p className="mt-7 text-center text-sm font-semibold text-slate-500">
              ...
              <Link
                to="/login"
                className="font-black text-emerald-700 underline decoration-2 underline-offset-4 hover:text-emerald-800"
              >
                Đăng nhập
              </Link>
            </p>
